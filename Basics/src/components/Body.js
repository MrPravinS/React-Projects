    ...
    <div className="">
      <div className=" flex justify-center items-center m-3 ">
        <input
          ...
          type="text"
          className="bg-gray-200 p-2 w-[300px] rounded-l-full"
        />
        <button
          onClick={() => {
          ...
          className="bg-blue-500 text-white px-2 py-2 rounded-r-full focus:ring-1 hover:bg-blue-600 transition duration-400 cursor-pointer font-bold"
        >
          Search
        </button>
      </div>
